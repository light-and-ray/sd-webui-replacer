...
def videoGenerateUI(
    ...
    *scripts_args,
    ...
    animatediff_args = AnimateDiffArgs(
        ...
        freeinit_enable=ad_freeinit_enable,
        freeinit_filter=ad_freeinit_filter,
        freeinit_ds=ad_freeinit_ds,
        freeinit_dt=ad_freeinit_dt,
        freeinit_iters=ad_freeinit_iters,
